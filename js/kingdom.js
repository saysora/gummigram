...
var authors = [
  {
    id: 1,
    name: "Sora",
    profileImage: "/gummigram/images/characters/sora-avatar.png",
  },
  {
    id: 2,
    name: "Kairi",
    profileImage: "/gummigram/images/characters/kairi-avatar.png",
  },
  {
    id: 3,
    name: "Riku",
    profileImage: "/gummigram/images/characters/riku-avatar.png",
  },
  {
    id: 4,
    name: "Aqua",
    profileImage: "/gummigram/images/characters/aqua-avatar.png",
  },
  {
    id: 5,
    name: "Terra",
    profileImage: "/gummigram/images/characters/terra-avatar.png",
  },
  {
    id: 6,
    name: "Ventus",
    profileImage: "/gummigram/images/characters/kh-ventus.png",
  },
  {
    id: 7,
    name: "Roxas",
    profileImage: "/gummigram/images/characters/roxas-avatar.png",
  },
  {
    id: 8,
    name: "Naminé",
    profileImage: "/gummigram/images/characters/namine-avatar.png",
  },
  {
    id: 9,
    name: "Axel",
    profileImage: "/gummigram/images/characters/kh-axel.png",
  },
  {
    id: 10,
    name: "Saïx",
    profileImage: "/gummigram/images/characters/kh-saix.png",
  },
  {
    id: 11,
    name: "Zexion",
    profileImage: "/gummigram/images/characters/kh-zexion.png",
  },
  {
    id: 12,
    name: "Xigbar",
    profileImage: "/gummigram/images/characters/kh-xigbar.png",
  },
  {
    id: 13,
    name: "Luxord",
    profileImage: "/gummigram/images/characters/kh-luxord.png",
  },
  {
    id: 14,
    name: "Xaldin",
    profileImage: "/gummigram/images/characters/kh-xaldin.png",
  },
  {
    id: 15,
    name: "Vexen",
    profileImage: "/gummigram/images/characters/kh-vexen.png",
  },
  {
    id: 16,
    name: "Demyx",
    profileImage: "/gummigram/images/characters/kh-demyx.png",
  },
  {
    id: 17,
    name: "Marluxia",
    profileImage: "/gummigram/images/characters/kh-marluxia.png",
  },
  {
    id: 18,
    name: "Larxene",
    profileImage: "/gummigram/images/characters/kh-larxene.png",
  },
  {
    id: 19,
    name: "Lexeaus",
    profileImage: "/gummigram/images/characters/kh-lexaus.png",
  },
  {
    id: 20,
    name: "Xemnas",
    profileImage: "/gummigram/images/characters/kh-xemnas.png",
  },
];
      ...
      comments: [
        {
          ...
          author: "2",
          message:
            "We never really got too much cold weather on Destiny Islands.",
        },
      ],
    },
    {
...
$(document).on("submit", ".comment-input-form", function (e) {
  ...
  var poster =
    $(this).find(".mini-char-selector").data("char") != 0
      ? person.id
      : currentUser.id;
...
$(document).on("click", ".comment-item", function (e) {
  ...
  if (!$(this).hasClass("editing")) {
    ...
    message.html(
      `<textarea class="comment-input-field edit">${original.trim()}</textarea>`
    );
...
function makeNewPost(author, image, caption) {
  var user = author;
  var propCaption = caption.replace(/(<([^>]+)>)/gi, "");
  ...
  while ((m = hashReg.exec(propCaption)) !== null) {
    ...
    m.forEach((match, groupIndex) => {
      ...
      propCaption.replace(
        match,
        '<span class="heart">' + match.replace("#", "") + "</span>"
      );
    });
  }
...
function listChars() {
  ...
  authors.forEach(function (author) {
    curUserList += `
    <div class="char-option ${author.id == 1 ? "active" : ""}" data-char="${
      author.id
    }">
...
function swapChar(author) {
  ...
  `);
  $(".selected-char")
    .closest(".mini-char-selector")
    .attr("data-char", author.id);
}
...
$(document).on("click", ".edit-post", function (e) {
  ...
  editPost.html(`
  <textarea class="item-caption-input" rows="4">${posts[
    post
  ].caption.trim()}</textarea>
  `);
    ...
    hashtag.forEach(function (hash) {
      ...
      index.html(
        index
          ...
          .replace(
            hash,
            ' <span class="heart">' + hash.replace("#", "").trim() + "</span> "
          )
      );
    });
  }
...
function checkImage(imageInput) {
  ...
  if (imgReg.test(imageInput)) {
    document.getElementById("dropURL").innerHTML =
      '<img class="image-preview" src="' + imageInput + '">';
